...
var toca;
    ...
    function preload()
{
    this.load.image('plata', './imagens/plataforma.png');
    this.load.image('piso', './imagens/plata.png');
    this.load.image('trem', './imagens/trem.png');
    this.load.spritesheet('boneco', './imagens/vilao.png', 115, 200);
    this.load.spritesheet('ninja', './imagens/ninja.png', 100, 100);
    this.load.spritesheet('bomba', './imagens/bomba.png', 32, 32);
    this.load.spritesheet('explosao', './imagens/explosion.png', 64, 64);
